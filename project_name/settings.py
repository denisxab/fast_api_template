...
class Mount(BaseMount):
    ...
    def mount_route(self):
        ...
        self.add_route(self.app, fast_xabhelper.user_pack.fast_user.router,
                       name="user_pack")
        self.add_route(self.app, fast_xabhelper.session_pack.fast_session.router,
                       name="session_pack")
        self.add_route(self.app, fast_xabhelper.admin_pack.fast_admin.router,
